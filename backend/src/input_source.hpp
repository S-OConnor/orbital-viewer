...
enum class InputMode {
  ...
  kDis,   // IEEE 1278.1 DIS Entity State PDUs (Phase 2)
};

// "olv1"/"dis" -> enum; returns false on any other string (strict, matching
...
// std::runtime_error for modes that are configured but not built (kDis until
// Phase 2 ships), and propagates the concrete type's constructor exceptions
